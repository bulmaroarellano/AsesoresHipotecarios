            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.transactions.inputs.folio')
                            </th>
                            <th class="text-left">
                            Solicitante
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ optional($transaction->applicant)->nombre .' ' . optional($transaction->applicant)->apellidos  ??
                                '-' }}
                            </td>
                            <td style="text-transform:capitalize">
                                {{
                                optional($transaction->order)->destino
                                ?? '-' }}
                            </td>
                            <td>
                                {{
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $transactions->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
